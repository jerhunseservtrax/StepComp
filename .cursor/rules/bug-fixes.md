...
5. Before Supabase challenge or leaderboard requests publish `ChallengeService` state, they must verify the active Supabase session still matches the user ID captured before the request.
