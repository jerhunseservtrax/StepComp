...
| System message RLS guard | `scripts/sql/FIX_CHALLENGE_MESSAGES_SYSTEM_TYPE_RLS.sql`, `IMPLEMENT_CHALLENGE_CHAT.sql` | Members can only INSERT/UPDATE `message_type=text`; system rows require SECURITY DEFINER RPCs |
