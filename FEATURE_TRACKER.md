...
| Offline Cache | `OfflineCacheService.swift`, `MetricsService.swift`, `ChallengeService.swift`, `AuthService.swift` | User-scoped disk-backed Codable cache with fetch-with-fallback for offline resilience and sign-out cleanup |
