...
| Stale Session Pause | `AbandonedWorkoutPolicy.swift`, `WorkoutViewModel.swift` | After 6h wall-clock, pause a restored/abandoned workout instead of silently finishing and syncing it |
