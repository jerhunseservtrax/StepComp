...
| Offline Cache | `OfflineCacheService.swift` | Generic disk-backed Codable cache with user-scoped fetch-with-fallback for offline resilience without cross-account data leakage |
