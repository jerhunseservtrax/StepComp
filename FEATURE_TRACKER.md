...
| Day-complete lockout | `WorkoutCompletionPolicy.swift`, `WorkoutViewModel.swift` | Start Workout stays available unless at least one set was checked off; empty Finish no longer locks the day |
