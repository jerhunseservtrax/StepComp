...
| Invite Code Collision Retry | `ChallengeService.swift` | Regenerates private challenge invite codes on unique collisions while preserving challenge category and image metadata |
