...
| Cache-Safe Auth Recovery | `AuthService.swift` | Cached profiles are validated against Supabase before authenticated routing; legacy UserDefaults cache migrates to Keychain |
