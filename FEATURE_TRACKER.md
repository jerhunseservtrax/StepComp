...
| Offline Cache | `OfflineCacheService.swift` | Disk-backed Codable cache with user-scoped fetch-with-fallback for offline resilience without cross-account data exposure |
