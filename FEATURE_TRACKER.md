...
| Weight Mode Continuity | `WorkoutViewModel.swift` | Carries total/per-side input mode across repeated workouts and newly added sets so weights and volume retain their original meaning |
