...
| Monotonic daily step upsert | `scripts/sql/FIX_SYNC_DAILY_STEPS_MONOTONIC_UPSERT.sql` | `sync_daily_steps` keeps `GREATEST` of existing vs incoming steps so lower late syncs cannot erase higher totals |
