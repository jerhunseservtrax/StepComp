...
final class ChatListViewModel: ObservableObject {
    ...
    private func getUserChallenges() async throws -> [SimpleChallengeInfo] {
        ...
        // Get challenge info for active chats only. Archived challenges still rely on
        // challenge_members for history, so this path must never delete ended memberships.
