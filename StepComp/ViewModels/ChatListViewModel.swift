...
final class ChatListViewModel: ObservableObject {
    ...
    private func getUserChallenges() async throws -> [SimpleChallengeInfo] {
        ...
        // Chat list only shows active challenge conversations. Never delete memberships
        // from this client-side read path; ended memberships preserve archived history.
